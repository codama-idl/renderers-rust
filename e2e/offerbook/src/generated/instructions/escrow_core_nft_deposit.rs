...
pub const ESCROW_CORE_NFT_DEPOSIT_DISCRIMINATOR: [u8; 8] = [190, 224, 133, 134, 189, 147, 71, 90];

/// Accounts.
#[derive(Debug)]
pub struct EscrowCoreNftDeposit {
...
impl EscrowCoreNftDeposit {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = EscrowCoreNftDepositInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct EscrowCoreNftDepositInstructionData {
    discriminator: [u8; 8],
}

impl EscrowCoreNftDepositInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for EscrowCoreNftDepositInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `EscrowCoreNftDeposit`.
///
/// ### Accounts:
///
...
pub struct EscrowCoreNftDepositBuilder {
...
impl EscrowCoreNftDepositBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = EscrowCoreNftDeposit {
...
/// `escrow_core_nft_deposit` CPI accounts.
pub struct EscrowCoreNftDepositCpiAccounts<'a, 'b> {
...
/// `escrow_core_nft_deposit` CPI instruction.
pub struct EscrowCoreNftDepositCpi<'a, 'b> {
...
impl<'a, 'b> EscrowCoreNftDepositCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: EscrowCoreNftDepositCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `EscrowCoreNftDeposit` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` signer
...
///   7. `[]` program
#[derive(Clone, Debug)]
pub struct EscrowCoreNftDepositCpiBuilder<'a, 'b> {
    instruction: Box<EscrowCoreNftDepositCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> EscrowCoreNftDepositCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(EscrowCoreNftDepositCpiBuilderInstruction {
            __program: program,
            signer: None,
            signer_user: None,
            asset: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = EscrowCoreNftDepositCpi {
...
#[derive(Clone, Debug)]
struct EscrowCoreNftDepositCpiBuilderInstruction<'a, 'b> {
