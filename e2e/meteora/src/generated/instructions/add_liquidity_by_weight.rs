...
pub const ADD_LIQUIDITY_BY_WEIGHT_DISCRIMINATOR: [u8; 8] = [28, 140, 238, 99, 231, 162, 21, 149];
...
pub struct AddLiquidityByWeight {
    ...
    pub bin_array_lower: solana_address::Address,

    pub bin_array_upper: solana_address::Address,
...
impl AddLiquidityByWeightInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
///   11. `[signer]` sender
///   12. `[optional]` token_x_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   13. `[optional]` token_y_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   14. `[]` event_authority
///   15. `[]` program
...
pub struct AddLiquidityByWeightBuilder {
    ...
    bin_array_lower: Option<solana_address::Address>,
    bin_array_upper: Option<solana_address::Address>,
...
impl AddLiquidityByWeightBuilder {
    ...
    #[inline(always)]
    pub fn bin_array_lower(&mut self, bin_array_lower: solana_address::Address) -> &mut Self {
        self.bin_array_lower = Some(bin_array_lower);
        self
    }
    #[inline(always)]
    pub fn bin_array_upper(&mut self, bin_array_upper: solana_address::Address) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = AddLiquidityByWeight {
            ...
            token_x_program: self.token_x_program.unwrap_or(solana_address::address!(
                "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"
            )),
            token_y_program: self.token_y_program.unwrap_or(solana_address::address!(
                "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA"
            )),
