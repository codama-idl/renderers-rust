...
pub struct InitializeReward {
    ...
    pub token_badge: Option<solana_address::Address>,
...
impl InitializeRewardBuilder {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn token_badge(&mut self, token_badge: Option<solana_address::Address>) -> &mut Self {
    ...
    #[inline(always)]
    pub fn funder(&mut self, funder: Address) -> &mut Self {
