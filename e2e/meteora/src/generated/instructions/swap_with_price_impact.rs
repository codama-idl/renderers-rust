...
pub const SWAP_WITH_PRICE_IMPACT_DISCRIMINATOR: [u8; 8] = [56, 173, 230, 208, 173, 228, 156, 205];
...
pub struct SwapWithPriceImpact {
    ...
    pub user_token_in: solana_address::Address,

    pub user_token_out: solana_address::Address,
    ...
    pub host_fee_in: Option<solana_address::Address>,
...
impl SwapWithPriceImpactInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
///   10. `[signer]` user
///   11. `[optional]` token_x_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   12. `[optional]` token_y_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   13. `[]` event_authority
///   14. `[]` program
...
pub struct SwapWithPriceImpactBuilder {
    ...
    user_token_in: Option<solana_address::Address>,
    user_token_out: Option<solana_address::Address>,
    token_x_mint: Option<solana_address::Address>,
    token_y_mint: Option<solana_address::Address>,
    oracle: Option<solana_address::Address>,
    host_fee_in: Option<solana_address::Address>,
...
impl SwapWithPriceImpactBuilder {
    ...
    #[inline(always)]
    pub fn user_token_in(&mut self, user_token_in: solana_address::Address) -> &mut Self {
        self.user_token_in = Some(user_token_in);
        self
    }
    #[inline(always)]
    pub fn user_token_out(&mut self, user_token_out: solana_address::Address) -> &mut Self {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn host_fee_in(&mut self, host_fee_in: Option<solana_address::Address>) -> &mut Self {
