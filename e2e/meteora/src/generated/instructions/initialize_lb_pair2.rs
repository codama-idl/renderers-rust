...
pub const INITIALIZE_LB_PAIR2_DISCRIMINATOR: [u8; 8] = [73, 59, 36, 120, 237, 83, 108, 198];
...
impl InitializeLbPair2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitializeLbPair2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl InitializeLbPair2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
