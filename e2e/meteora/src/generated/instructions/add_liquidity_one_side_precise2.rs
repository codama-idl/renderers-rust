...
pub const ADD_LIQUIDITY_ONE_SIDE_PRECISE2_DISCRIMINATOR: [u8; 8] =
...
impl AddLiquidityOneSidePrecise2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddLiquidityOneSidePrecise2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl AddLiquidityOneSidePrecise2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
