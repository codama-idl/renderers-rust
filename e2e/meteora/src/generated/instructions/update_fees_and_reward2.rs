...
pub const UPDATE_FEES_AND_REWARD2_DISCRIMINATOR: [u8; 8] = [32, 142, 184, 154, 103, 65, 184, 88];
...
impl UpdateFeesAndReward2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateFeesAndReward2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl UpdateFeesAndReward2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
