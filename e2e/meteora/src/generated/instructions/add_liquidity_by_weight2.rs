...
use crate::generated::types::LiquidityParameterByWeight;
use crate::generated::types::RemainingAccountsInfo;
use borsh::BorshDeserialize;
use borsh::BorshSerialize;

pub const ADD_LIQUIDITY_BY_WEIGHT2_DISCRIMINATOR: [u8; 8] = [209, 59, 63, 91, 111, 200, 153, 228];
...
impl AddLiquidityByWeight2 {
    pub fn instruction(
        &self,
        args: AddLiquidityByWeight2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddLiquidityByWeight2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct AddLiquidityByWeight2InstructionData {
    discriminator: [u8; 8],
}

impl AddLiquidityByWeight2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for AddLiquidityByWeight2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct AddLiquidityByWeight2InstructionArgs {
    pub liquidity_parameter: LiquidityParameterByWeight,
    pub remaining_accounts_info: RemainingAccountsInfo,
}

impl AddLiquidityByWeight2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `AddLiquidityByWeight2`.
///
/// ### Accounts:
///
///   0. `[writable]` position
...
pub struct AddLiquidityByWeight2Builder {
    ...
    liquidity_parameter: Option<LiquidityParameterByWeight>,
    remaining_accounts_info: Option<RemainingAccountsInfo>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl AddLiquidityByWeight2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = AddLiquidityByWeight2 {
        ...
        let args = AddLiquidityByWeight2InstructionArgs {
...
/// `add_liquidity_by_weight2` CPI accounts.
pub struct AddLiquidityByWeight2CpiAccounts<'a, 'b> {
...
/// `add_liquidity_by_weight2` CPI instruction.
pub struct AddLiquidityByWeight2Cpi<'a, 'b> {
    ...
    pub __args: AddLiquidityByWeight2InstructionArgs,
}

impl<'a, 'b> AddLiquidityByWeight2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: AddLiquidityByWeight2CpiAccounts<'a, 'b>,
        args: AddLiquidityByWeight2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `AddLiquidityByWeight2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` position
...
///   13. `[]` program
#[derive(Clone, Debug)]
pub struct AddLiquidityByWeight2CpiBuilder<'a, 'b> {
    instruction: Box<AddLiquidityByWeight2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddLiquidityByWeight2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AddLiquidityByWeight2CpiBuilderInstruction {
            __program: program,
            position: None,
            lb_pair: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = AddLiquidityByWeight2Cpi {
...
#[derive(Clone, Debug)]
struct AddLiquidityByWeight2CpiBuilderInstruction<'a, 'b> {
