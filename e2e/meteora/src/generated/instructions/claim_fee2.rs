...
pub const CLAIM_FEE2_DISCRIMINATOR: [u8; 8] = [112, 191, 101, 171, 28, 144, 127, 187];
...
impl ClaimFee2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ClaimFee2InstructionData::new().try_to_vec().unwrap();
...
///   9. `[]` token_program_x
///   10. `[]` token_program_y
///   11. `[optional]` memo_program (default to `MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr`)
///   12. `[]` event_authority
///   13. `[]` program
