...
pub const INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR2_DISCRIMINATOR: [u8; 8] =
...
impl InitializeCustomizablePermissionlessLbPair2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitializeCustomizablePermissionlessLbPair2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl InitializeCustomizablePermissionlessLbPair2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
