...
pub const SET_PRE_ACTIVATION_SWAP_ADDRESS_DISCRIMINATOR: [u8; 8] =
...
pub struct SetPreActivationSwapAddressInstructionArgs {
    pub pre_activation_swap_address: Address,
}

impl SetPreActivationSwapAddressInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct SetPreActivationSwapAddressBuilder {
    ...
    pre_activation_swap_address: Option<Address>,
...
impl SetPreActivationSwapAddressBuilder {
    ...
    pub fn pre_activation_swap_address(
        &mut self,
        pre_activation_swap_address: Address,
    ) -> &mut Self {
