...
pub const UPDATE_BASE_FEE_PARAMETERS_DISCRIMINATOR: [u8; 8] = [75, 168, 223, 161, 16, 195, 3, 47];
...
impl UpdateBaseFeeParameters {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateBaseFeeParametersInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl UpdateBaseFeeParametersInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
