...
pub const ADD_LIQUIDITY_BY_STRATEGY2_DISCRIMINATOR: [u8; 8] =
...
impl AddLiquidityByStrategy2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AddLiquidityByStrategy2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl AddLiquidityByStrategy2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
