...
pub const INITIALIZE_POSITION2_DISCRIMINATOR: [u8; 8] = [143, 19, 242, 145, 213, 15, 104, 115];
...
impl InitializePosition2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitializePosition2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct InitializePosition2InstructionData {
    discriminator: [u8; 8],
}

impl InitializePosition2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for InitializePosition2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct InitializePosition2InstructionArgs {
    pub lower_bin_id: i32,
    pub width: i32,
}

impl InitializePosition2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `InitializePosition2`.
///
/// ### Accounts:
///
...
pub struct InitializePosition2Builder {
...
impl InitializePosition2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = InitializePosition2 {
        ...
        let args = InitializePosition2InstructionArgs {
...
/// `initialize_position2` CPI accounts.
pub struct InitializePosition2CpiAccounts<'a, 'b> {
...
/// `initialize_position2` CPI instruction.
pub struct InitializePosition2Cpi<'a, 'b> {
    ...
    pub __args: InitializePosition2InstructionArgs,
}

impl<'a, 'b> InitializePosition2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: InitializePosition2CpiAccounts<'a, 'b>,
        args: InitializePosition2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InitializePosition2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   6. `[]` program
#[derive(Clone, Debug)]
pub struct InitializePosition2CpiBuilder<'a, 'b> {
    instruction: Box<InitializePosition2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializePosition2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InitializePosition2CpiBuilderInstruction {
            __program: program,
            payer: None,
            position: None,
            lb_pair: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = InitializePosition2Cpi {
...
#[derive(Clone, Debug)]
struct InitializePosition2CpiBuilderInstruction<'a, 'b> {
