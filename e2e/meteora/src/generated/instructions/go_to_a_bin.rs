...
pub const GO_TO_A_BIN_DISCRIMINATOR: [u8; 8] = [146, 72, 174, 224, 40, 253, 84, 174];
...
pub struct GoToABin {
    ...
    pub from_bin_array: Option<solana_address::Address>,

    pub to_bin_array: Option<solana_address::Address>,
...
pub struct GoToABinBuilder {
    ...
    from_bin_array: Option<solana_address::Address>,
    to_bin_array: Option<solana_address::Address>,
...
impl GoToABinBuilder {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn from_bin_array(&mut self, from_bin_array: Option<solana_address::Address>) -> &mut Self {
        self.from_bin_array = from_bin_array;
        self
    }
    /// `[optional account]`
    #[inline(always)]
    pub fn to_bin_array(&mut self, to_bin_array: Option<solana_address::Address>) -> &mut Self {
