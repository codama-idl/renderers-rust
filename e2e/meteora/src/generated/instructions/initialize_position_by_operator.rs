...
pub const INITIALIZE_POSITION_BY_OPERATOR_DISCRIMINATOR: [u8; 8] =
...
pub struct InitializePositionByOperator {
    ...
    pub operator_token_x: solana_address::Address,
...
pub struct InitializePositionByOperatorInstructionArgs {
    ...
    pub width: i32,
    pub fee_owner: Address,
    pub lock_release_point: u64,
}

impl InitializePositionByOperatorInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
pub struct InitializePositionByOperatorBuilder {
    ...
    operator_token_x: Option<solana_address::Address>,
...
impl InitializePositionByOperatorBuilder {
    ...
    #[inline(always)]
    pub fn operator_token_x(&mut self, operator_token_x: solana_address::Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn fee_owner(&mut self, fee_owner: Address) -> &mut Self {
