...
pub const REMOVE_LIQUIDITY_BY_RANGE2_DISCRIMINATOR: [u8; 8] = [204, 2, 195, 145, 53, 145, 145, 205];
...
impl RemoveLiquidityByRange2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = RemoveLiquidityByRange2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl RemoveLiquidityByRange2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
