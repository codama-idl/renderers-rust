...
pub const INITIALIZE_BIN_ARRAY_BITMAP_EXTENSION_DISCRIMINATOR: [u8; 8] =
...
pub struct InitializeBinArrayBitmapExtension {
    ...
    pub bin_array_bitmap_extension: solana_address::Address,
...
impl InitializeBinArrayBitmapExtensionBuilder {
    ...
    pub fn bin_array_bitmap_extension(
        &mut self,
        bin_array_bitmap_extension: solana_address::Address,
    ) -> &mut Self {
