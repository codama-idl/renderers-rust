...
pub const INITIALIZE_PERMISSION_LB_PAIR_DISCRIMINATOR: [u8; 8] =
...
pub struct InitializePermissionLbPair {
    ...
    pub token_mint_x: solana_address::Address,

    pub token_mint_y: solana_address::Address,
    ...
    pub token_badge_x: Option<solana_address::Address>,

    pub token_badge_y: Option<solana_address::Address>,

    pub token_program_x: solana_address::Address,

    pub token_program_y: solana_address::Address,
...
impl InitializePermissionLbPairInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
...
///   9. `[]` operator
///   10. `[signer]` signer
///   11. `[optional]` token_badge_x
///   12. `[optional]` token_badge_y
///   13. `[]` token_program_x
///   14. `[]` token_program_y
...
pub struct InitializePermissionLbPairBuilder {
    ...
    token_mint_x: Option<solana_address::Address>,
    token_mint_y: Option<solana_address::Address>,
    ...
    token_badge_x: Option<solana_address::Address>,
    token_badge_y: Option<solana_address::Address>,
    token_program_x: Option<solana_address::Address>,
    token_program_y: Option<solana_address::Address>,
...
impl InitializePermissionLbPairBuilder {
    ...
    #[inline(always)]
    pub fn token_mint_x(&mut self, token_mint_x: solana_address::Address) -> &mut Self {
        self.token_mint_x = Some(token_mint_x);
        self
    }
    #[inline(always)]
    pub fn token_mint_y(&mut self, token_mint_y: solana_address::Address) -> &mut Self {
    ...
    /// `[optional account]`
    #[inline(always)]
    pub fn token_badge_x(&mut self, token_badge_x: Option<solana_address::Address>) -> &mut Self {
        self.token_badge_x = token_badge_x;
        self
    }
    /// `[optional account]`
    #[inline(always)]
    pub fn token_badge_y(&mut self, token_badge_y: Option<solana_address::Address>) -> &mut Self {
        self.token_badge_y = token_badge_y;
        self
    }
    #[inline(always)]
    pub fn token_program_x(&mut self, token_program_x: solana_address::Address) -> &mut Self {
        self.token_program_x = Some(token_program_x);
        self
    }
    #[inline(always)]
    pub fn token_program_y(&mut self, token_program_y: solana_address::Address) -> &mut Self {
    ...
    #[inline(always)]
    pub fn padding0(&mut self, padding0: u16) -> &mut Self {
