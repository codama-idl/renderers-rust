...
pub const INCREASE_POSITION_LENGTH2_DISCRIMINATOR: [u8; 8] =
...
impl IncreasePositionLength2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = IncreasePositionLength2InstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct IncreasePositionLength2InstructionData {
    discriminator: [u8; 8],
}

impl IncreasePositionLength2InstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for IncreasePositionLength2InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct IncreasePositionLength2InstructionArgs {
    pub minimum_upper_bin_id: i32,
}

impl IncreasePositionLength2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `IncreasePositionLength2`.
///
/// ### Accounts:
///
...
pub struct IncreasePositionLength2Builder {
    ...
    minimum_upper_bin_id: Option<i32>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl IncreasePositionLength2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn minimum_upper_bin_id(&mut self, minimum_upper_bin_id: i32) -> &mut Self {
        self.minimum_upper_bin_id = Some(minimum_upper_bin_id);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = IncreasePositionLength2 {
        ...
        let args = IncreasePositionLength2InstructionArgs {
            minimum_upper_bin_id: self
                .minimum_upper_bin_id
                .clone()
                .expect("minimum_upper_bin_id is not set"),
        };
...
/// `increase_position_length2` CPI accounts.
pub struct IncreasePositionLength2CpiAccounts<'a, 'b> {
...
/// `increase_position_length2` CPI instruction.
pub struct IncreasePositionLength2Cpi<'a, 'b> {
    ...
    pub __args: IncreasePositionLength2InstructionArgs,
}

impl<'a, 'b> IncreasePositionLength2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: IncreasePositionLength2CpiAccounts<'a, 'b>,
        args: IncreasePositionLength2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `IncreasePositionLength2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` funder
...
///   6. `[]` program
#[derive(Clone, Debug)]
pub struct IncreasePositionLength2CpiBuilder<'a, 'b> {
    instruction: Box<IncreasePositionLength2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> IncreasePositionLength2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(IncreasePositionLength2CpiBuilderInstruction {
            __program: program,
            funder: None,
            lb_pair: None,
            position: None,
    ...
    #[inline(always)]
    pub fn minimum_upper_bin_id(&mut self, minimum_upper_bin_id: i32) -> &mut Self {
        self.instruction.minimum_upper_bin_id = Some(minimum_upper_bin_id);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = IncreasePositionLength2Cpi {
...
#[derive(Clone, Debug)]
struct IncreasePositionLength2CpiBuilderInstruction<'a, 'b> {
