...
pub const CLAIM_REWARD2_DISCRIMINATOR: [u8; 8] = [190, 3, 127, 119, 178, 87, 157, 183];
...
impl ClaimReward2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ClaimReward2InstructionData::new().try_to_vec().unwrap();
...
impl ClaimReward2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
