...
pub const UPDATE_DYNAMIC_FEE_PARAMETERS_DISCRIMINATOR: [u8; 8] =
...
impl UpdateDynamicFeeParameters {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateDynamicFeeParametersInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl UpdateDynamicFeeParametersInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}
