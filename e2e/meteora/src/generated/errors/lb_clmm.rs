...
pub enum LbClmmError {
    ...
    InvalidRebalanceParameters = 0x17C3,
    /// 6084 - Invalid reward accounts
    #[error("Invalid reward accounts")]
    InvalidRewardAccounts = 0x17C4,
    /// 6085 - Undetermined error
    #[error("Undetermined error")]
    UndeterminedError = 0x17C5,
    /// 6086 - Realloc exceed max length per instruction
    #[error("Realloc exceed max length per instruction")]
    ReallocExceedMaxLengthPerInstruction = 0x17C6,
    /// 6087 - Mantissa cannot more than two significant digits
    #[error("Mantissa cannot more than two significant digits")]
    InvalidBaseFeeMantissa = 0x17C7,
    /// 6088 - Invalid position owner
    #[error("Invalid position owner")]
    InvalidPositionOwner = 0x17C8,
    /// 6089 - Invalid pool address
    #[error("Invalid pool address")]
    InvalidPoolAddress = 0x17C9,
    /// 6090 - Invalid token badge type
    #[error("Invalid token badge type")]
    InvalidTokenBadgeType = 0x17CA,
    /// 6091 - Invalid transfer hook authority
    #[error("Invalid transfer hook authority")]
    InvalidTransferHookAuthority = 0x17CB,
    /// 6092 - Amount x is negative
    #[error("Amount x is negative")]
    AmountXIsNegative = 0x17CC,
    /// 6093 - Amount y is negative
    #[error("Amount y is negative")]
    AmountYIsNegative = 0x17CD,
    /// 6094 - Invalid pool creator
    #[error("Invalid pool creator")]
    InvalidPoolCreator = 0x17CE,
    /// 6095 - Invalid function type
    #[error("Invalid function type")]
    InvalidFunctionType = 0x17CF,
    /// 6096 - Invalid permission
    #[error("Invalid permission")]
    InvalidPermission = 0x17D0,
    /// 6097 - Incorrect ATA
    #[error("Incorrect ATA")]
    IncorrectATA = 0x17D1,
    /// 6098 - Invalid withdraw protocol fee zap accounts
    #[error("Invalid withdraw protocol fee zap accounts")]
    InvalidWithdrawProtocolFeeZapAccounts = 0x17D2,
    /// 6099 - SOL,USDC protocol fee cannot be withdrawn via zap
    #[error("SOL,USDC protocol fee cannot be withdrawn via zap")]
    MintRestrictedFromZap = 0x17D3,
    /// 6100 - CPI disabled
    #[error("CPI disabled")]
    CpiDisabled = 0x17D4,
    /// 6101 - Missing zap out instruction
    #[error("Missing zap out instruction")]
    MissingZapOutInstruction = 0x17D5,
    /// 6102 - Invalid zap accounts
    #[error("Invalid zap accounts")]
    InvalidZapAccounts = 0x17D6,
    /// 6103 - Invalid zap out parameters
    #[error("Invalid zap out parameters")]
    InvalidZapOutParameters = 0x17D7,
    /// 6104 - Insufficient in amount
    #[error("Insufficient in amount")]
    InsufficientInAmount = 0x17D8,
    /// 6105 - Invalid place limit order parameters
    #[error("Invalid place limit order parameters")]
    InvalidPlaceLimitOrderParameters = 0x17D9,
    /// 6106 - Invalid limit order owner
    #[error("Invalid limit order owner")]
    InvalidLimitOrderOwner = 0x17DA,
    /// 6107 - Invalid cancel limit order parameters
    #[error("Invalid cancel limit order parameters")]
    InvalidCancelLimitOrderParameters = 0x17DB,
    /// 6108 - Cannot find limit order by bin id
    #[error("Cannot find limit order by bin id")]
    CannotFindLimitOrderByBinId = 0x17DC,
    /// 6109 - Cannot cancel non-empty limit order
    #[error("Cannot cancel non-empty limit order")]
    CancelNonEmptyLimitOrder = 0x17DD,
    /// 6110 - Invalid collect fee mode
    #[error("Invalid collect fee mode")]
    InvalidCollectFeeMode = 0x17DE,
}
