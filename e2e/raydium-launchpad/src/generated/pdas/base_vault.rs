...
pub const BASE_VAULT_SEED: &'static [u8] = &[112, 111, 111, 108, 95, 118, 97, 117, 108, 116];
pub fn create_base_vault_pda(
    pool_state: Address,
    base_mint: Address,
    bump: u8,
...
pub fn find_base_vault_pda(
    pool_state: &Address,
    base_mint: &Address,
) -> (solana_address::Address, u8) {
    solana_address::Address::find_program_address(
        &[BASE_VAULT_SEED, pool_state.as_ref(), base_mint.as_ref()],
        &RAYDIUM_LAUNCHPAD_ID,
    )
}
