...
pub const QUOTE_VAULT_SEED: &'static [u8] = &[112, 111, 111, 108, 95, 118, 97, 117, 108, 116];
pub fn create_quote_vault_pda(
    pool_state: Address,
    quote_mint: Address,
    bump: u8,
...
pub fn find_quote_vault_pda(
    pool_state: &Address,
    quote_mint: &Address,
) -> (solana_address::Address, u8) {
    solana_address::Address::find_program_address(
        &[QUOTE_VAULT_SEED, pool_state.as_ref(), quote_mint.as_ref()],
        &RAYDIUM_LAUNCHPAD_ID,
    )
}
